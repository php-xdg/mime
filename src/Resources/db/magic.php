...
return new MagicDatabase(
    ...
    rules: [
        ...
        new MagicRule('application/x-docbook+xml', 90, 126, [
            new MagicMatch(0, 1, '<?xml', '', 0, [new MagicMatch(0, 101, '-//OASIS//DTD DocBook XML', '', 0), new MagicMatch(0, 101, '-//KDE//DTD DocBook XML', '', 0)]),
        ]),
        new MagicRule('image/x-eps', 90, 20, [
            new MagicMatch(0, 1, '%!', '', 0, [new MagicMatch(15, 1, 'EPS', '', 0)]),
            new MagicMatch(0, 1, "\x04%!", '', 0, [new MagicMatch(16, 1, 'EPS', '', 0)]),
        ...
        new MagicRule('application/vnd.corel-draw', 80, 17, [
            new MagicMatch(8, 1, 'CDRXvrsn', "\xFF\xFF\xFF\x00\xFF\xFF\xFF\xFF", 0),
        ]),
        new MagicRule('application/x-fictionbook+xml', 80, 269, [
            new MagicMatch(0, 257, '<FictionBook', '', 0),
        ]),
        ...
        new MagicRule('application/x-mozilla-bookmarks', 80, 100, [
            new MagicMatch(0, 65, '<!DOCTYPE NETSCAPE-Bookmark-file-1>', '', 0),
        ]),
        new MagicRule('application/x-nzb', 80, 261, [
            new MagicMatch(0, 257, '<nzb', '', 0),
        ]),
        new MagicRule('application/x-pak', 80, 5, [
            new MagicMatch(0, 1, 'PACK', '', 0),
        ]),
        new MagicRule('application/x-php', 80, 70, [
            new MagicMatch(0, 65, '<?php', '', 0),
        ]),
        new MagicRule('application/xliff+xml', 80, 263, [
            new MagicMatch(0, 257, '<xliff', '', 0),
        ]),
        new MagicRule('audio/x-flac+ogg', 80, 34, [
            new MagicMatch(0, 1, 'OggS', '', 0, [new MagicMatch(28, 1, 'fLaC', '', 0)]),
            new MagicMatch(0, 1, 'OggS', '', 0, [new MagicMatch(28, 1, "\x7FFLAC", '', 0)]),
        ]),
        new MagicRule('audio/x-opus+ogg', 80, 37, [
            new MagicMatch(0, 1, 'OggS', '', 0, [new MagicMatch(28, 1, 'OpusHead', '', 0)]),
        ]),
        new MagicRule('audio/x-speex+ogg', 80, 36, [
            new MagicMatch(0, 1, 'OggS', '', 0, [new MagicMatch(28, 1, 'Speex  ', '', 0)]),
        ]),
        new MagicRule('audio/x-vorbis+ogg', 80, 36, [
            new MagicMatch(0, 1, 'OggS', '', 0, [new MagicMatch(28, 1, "\x01vorbis", '', 0)]),
        ]),
        new MagicRule('image/astc', 80, 5, [
            new MagicMatch(0, 1, "\x13\xAB\xA1\\", '', 0),
        ]),
        new MagicRule('image/ktx', 80, 13, [
            new MagicMatch(0, 1, "\xABKTX", '', 0, [new MagicMatch(4, 1, " 11\xBB", '', 0, [new MagicMatch(8, 1, "\r\n\x1A\n", '', 0)])]),
        ]),
        new MagicRule('image/ktx2', 80, 13, [
            new MagicMatch(0, 1, "\xABKTX", '', 0, [new MagicMatch(4, 1, " 20\xBB", '', 0, [new MagicMatch(8, 1, "\r\n\x1A\n", '', 0)])]),
        ]),
        new MagicRule('image/svg+xml', 80, 270, [
            new MagicMatch(0, 257, '<!DOCTYPE svg', '', 0),
        ]),
        ...
        new MagicRule('image/vnd.djvu', 80, 17, [
            new MagicMatch(0, 1, 'AT&TFORM', '', 0, [new MagicMatch(12, 1, 'DJVU', '', 0)]),
            new MagicMatch(0, 1, 'FORM', '', 0, [new MagicMatch(8, 1, 'DJVU', '', 0)]),
        ]),
        new MagicRule('image/vnd.djvu+multipage', 80, 17, [
            new MagicMatch(0, 1, 'AT&TFORM', '', 0, [new MagicMatch(12, 1, 'DJVM', '', 0)]),
            new MagicMatch(0, 1, 'FORM', '', 0, [new MagicMatch(8, 1, 'DJVM', '', 0)]),
        ]),
        ...
        new MagicRule('video/x-ogm+ogg', 80, 35, [
            new MagicMatch(0, 1, 'OggS', '', 0, [new MagicMatch(29, 1, 'video', '', 0)]),
        ]),
        new MagicRule('video/x-theora+ogg', 80, 36, [
            new MagicMatch(0, 1, 'OggS', '', 0, [new MagicMatch(28, 1, "\x80theora", '', 0)]),
        ]),
        new MagicRule('application/atom+xml', 70, 263, [
            new MagicMatch(0, 257, '<feed ', '', 0),
        ]),
        new MagicRule('application/epub+zip', 70, 64, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/epub+zip', '', 0), new MagicMatch(43, 1, 'application/epub+zip', '', 0)])]),
        ]),
        new MagicRule('application/rss+xml', 70, 262, [
            new MagicMatch(0, 257, '<rss ', '', 0),
            new MagicMatch(0, 257, '<RSS ', '', 0),
        ]),
        new MagicRule('application/vnd.apple.keynote', 70, 41, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'index.apxl', '', 0)]),
        ]),
        new MagicRule('application/vnd.apple.mpegurl', 70, 150, [
            new MagicMatch(0, 1, '#EXTM3U', '', 0, [new MagicMatch(0, 129, '#EXT-X-TARGETDURATION', '', 0), new MagicMatch(0, 129, '#EXT-X-STREAM-INF', '', 0)]),
        ]),
        new MagicRule('application/vnd.apple.pages', 70, 49, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'index.xml', '', 0), new MagicMatch(30, 1, 'Index/Document.iwa', '', 0)]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.chart', 70, 79, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.chart', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.chart-template', 70, 88, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.chart-template', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.database', 70, 78, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.base', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.formula', 70, 81, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.formula', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.formula-template', 70, 90, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.formula-template', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.graphics', 70, 82, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.graphics', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.graphics-template', 70, 91, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.graphics-template', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.image', 70, 79, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.image', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.presentation', 70, 86, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.presentation', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.presentation-template', 70, 95, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.presentation-template', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.spreadsheet', 70, 85, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.spreadsheet', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.spreadsheet-template', 70, 94, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.spreadsheet-template', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.text', 70, 78, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.text', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.text-master', 70, 85, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.text-master', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.text-template', 70, 87, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.text-template', '', 0)])]),
        ]),
        new MagicRule('application/vnd.oasis.opendocument.text-web', 70, 82, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.oasis.opendocument.text-web', '', 0)])]),
        ]),
        new MagicRule('application/vnd.sun.xml.calc', 70, 67, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.sun.xml.calc', '', 0)])]),
        ]),
        new MagicRule('application/vnd.sun.xml.calc.template', 70, 67, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.sun.xml.calc', '', 0)])]),
        ]),
        new MagicRule('application/vnd.sun.xml.draw', 70, 67, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.sun.xml.draw', '', 0)])]),
        ]),
        new MagicRule('application/vnd.sun.xml.draw.template', 70, 67, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.sun.xml.draw', '', 0)])]),
        ]),
        new MagicRule('application/vnd.sun.xml.impress', 70, 70, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.sun.xml.impress', '', 0)])]),
        ]),
        new MagicRule('application/vnd.sun.xml.impress.template', 70, 70, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.sun.xml.impress', '', 0)])]),
        ]),
        new MagicRule('application/vnd.sun.xml.math', 70, 67, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.sun.xml.math', '', 0)])]),
        ]),
        new MagicRule('application/vnd.sun.xml.writer', 70, 69, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/vnd.sun.xml.writer', '', 0)])]),
        ]),
        ...
        new MagicRule('application/x-zip-compressed-fb2', 70, 261, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 227, '.fb2', '', 0)]),
        ]),
        new MagicRule('image/openraster', 70, 55, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'image/openraster', '', 0)])]),
        ]),
        new MagicRule('text/x-opml+xml', 70, 263, [
            new MagicMatch(0, 257, '<opml ', '', 0),
        ]),
        new MagicRule('application/vnd.apple.numbers', 65, 49, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'index.xml', '', 0), new MagicMatch(30, 1, 'Index/Document.iwa', '', 0)]),
        ]),
        new MagicRule('application/vnd.apple.pkpass', 65, 40, [
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'pass.json', '', 0)]),
        ]),
        new MagicRule('application/msword', 60, 2141, [
            ...
            new MagicMatch(2112, 1, 'MSWordDoc', '', 0),
            new MagicMatch(2108, 1, 'MSWordDoc', '', 0),
            new MagicMatch(2112, 1, 'Microsoft Word document data', '', 0),
            new MagicMatch(546, 1, 'bjbj', '', 0),
            new MagicMatch(546, 1, 'jbjb', '', 0),
        ]),
        new MagicRule('application/ovf', 60, 266, [
            new MagicMatch(1, 256, '.ovf', '', 0, [new MagicMatch(257, 1, "ustar\x00", '', 0), new MagicMatch(257, 1, "ustar  \x00", '', 0)]),
        ]),
        ...
        new MagicRule('application/x-font-type1', 60, 70, [
            ...
            new MagicMatch(65, 1, 'LWFN', '', 0),
            new MagicMatch(0, 1, '%!PS-AdobeFont-1.', '', 0),
            new MagicMatch(6, 1, '%!PS-AdobeFont-1.', '', 0),
            new MagicMatch(0, 1, '%!FontType1-1.', '', 0),
            new MagicMatch(6, 1, '%!FontType1-1.', '', 0),
        ]),
        new MagicRule('application/x-java-pack200', 60, 5, [
            new MagicMatch(0, 1, "\xCA\xFE\xD0\r", '', 0),
        ]),
        new MagicRule('application/x-karbon', 60, 59, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-karbon\x04\x06", '', 0)])]),
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/x-karbon', '', 0)])]),
        ]),
        new MagicRule('application/x-kchart', 60, 59, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-kchart\x04\x06", '', 0)])]),
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/x-kchart', '', 0)])]),
        ]),
        new MagicRule('application/x-kformula', 60, 61, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-kformula\x04\x06", '', 0)])]),
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/x-kformula', '', 0)])]),
        ]),
        new MagicRule('application/x-killustrator', 60, 47, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-killustrator\x04\x06", '', 0)])]),
        ]),
        new MagicRule('application/x-kivio', 60, 58, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-kivio\x04\x06", '', 0)])]),
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/x-kivio', '', 0)])]),
        ]),
        new MagicRule('application/x-kontour', 60, 60, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-kontour\x04\x06", '', 0)])]),
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/x-kontour', '', 0)])]),
        ]),
        new MagicRule('application/x-kpresenter', 60, 63, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-kpresenter\x04\x06", '', 0)])]),
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/x-kpresenter', '', 0)])]),
        ]),
        new MagicRule('application/x-krita', 60, 83, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-krita\x04\x06", '', 0)])]),
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/x-krita', '', 0), new MagicMatch(42, 1, 'application/x-krita', '', 0), new MagicMatch(63, 1, 'application/x-krita', '', 0)])]),
        ]),
        new MagicRule('application/x-kspread', 60, 60, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-kspread\x04\x06", '', 0)])]),
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/x-kspread', '', 0)])]),
        ]),
        new MagicRule('application/x-kword', 60, 58, [
            new MagicMatch(0, 1, "\x1F\x8B", '', 0, [new MagicMatch(10, 1, 'KOffice', '', 0, [new MagicMatch(18, 1, "application/x-kword\x04\x06", '', 0)])]),
            new MagicMatch(0, 1, "PK\x03\x04", '', 0, [new MagicMatch(30, 1, 'mimetype', '', 0, [new MagicMatch(38, 1, 'application/x-kword', '', 0)])]),
        ]),
        new MagicRule('application/x-lha', 60, 9, [
            new MagicMatch(2, 1, '-lh -', '', 0),
            new MagicMatch(2, 1, '-lh0-', '', 0),
            new MagicMatch(2, 1, '-lh1-', '', 0),
            new MagicMatch(2, 1, '-lh2-', '', 0),
            new MagicMatch(2, 1, '-lh3-', '', 0),
            new MagicMatch(2, 1, '-lh4-', '', 0),
            new MagicMatch(2, 1, '-lh5-', '', 0),
            new MagicMatch(2, 1, '-lh40-', '', 0),
            new MagicMatch(2, 1, '-lhd-', '', 0),
            new MagicMatch(2, 1, '-lz4-', '', 0),
            new MagicMatch(2, 1, '-lz5-', '', 0),
            new MagicMatch(2, 1, '-lzs-', '', 0),
        ]),
        ...
        new MagicRule('application/x-quicktime-media-link', 60, 76, [
            new MagicMatch(0, 1, '<?xml', '', 0, [new MagicMatch(0, 65, '<?quicktime', '', 0)]),
            new MagicMatch(0, 1, 'RTSPtext', '', 0),
            new MagicMatch(0, 1, 'rtsptext', '', 0),
            new MagicMatch(0, 1, 'SMILtext', '', 0),
        ]),
        new MagicRule('application/x-sega-cd-rom', 60, 277, [
            new MagicMatch(0, 1, 'SEGADISCSYSTEM', '', 0, [new MagicMatch(256, 1, 'SEGA', '', 0)]),
            new MagicMatch(16, 1, 'SEGADISCSYSTEM', '', 0, [new MagicMatch(272, 1, 'SEGA', '', 0)]),
        ]),
        ...
        new MagicRule('application/x-tar', 60, 266, [
            new MagicMatch(257, 1, "ustar\x00", '', 0),
            new MagicMatch(257, 1, "ustar  \x00", '', 0),
        ]),
        ...
        new MagicRule('application/xhtml+xml', 60, 306, [
            new MagicMatch(0, 257, '//W3C//DTD XHTML ', '', 0),
            new MagicMatch(0, 257, 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd', '', 0),
            new MagicMatch(0, 257, '<html xmlns="http://www.w3.org/1999/xhtml', '', 0),
            new MagicMatch(0, 257, '<HTML xmlns="http://www.w3.org/1999/xhtml', '', 0),
        ]),
        ...
        new MagicRule('audio/vnd.dts.hd', 60, 18730, [
            new MagicMatch(0, 1, "\x7F\xFE\x80\x01", '', 0, [new MagicMatch(4, 18722, 'dX %', '', 0)]),
        ]),
        new MagicRule('text/x-python3', 60, 34, [
            ...
            new MagicMatch(2, 15, '/bin/env python3', '', 0),
        ]),
        ...
        new MagicRule('application/smil+xml', 55, 262, [
            new MagicMatch(0, 257, '<smil', '', 0),
        ]),
        new MagicRule('audio/x-ms-asx', 51, 69, [
            new MagicMatch(0, 1, 'ASF ', '', 0),
            new MagicMatch(0, 65, '<ASX', '', 0),
            new MagicMatch(0, 65, '<asx', '', 0),
            new MagicMatch(0, 65, '<Asx', '', 0),
        ]),
        new MagicRule('application/annodex', 50, 521, [
            new MagicMatch(0, 1, 'OggS', '', 0, [new MagicMatch(28, 1, "fishead\x00", '', 0, [new MagicMatch(56, 457, "CMML\x00\x00\x00\x00", '', 0)])]),
        ]),
        ...
        new MagicRule('application/mathematica', 50, 322, [
            ...
            new MagicMatch(100, 157, 'This notebook can be used on any computer system with Mathematica', '', 0),
            new MagicMatch(10, 247, 'This is a Mathematica Notebook file.  It contains ASCII text', '', 0),
        ]),
        new MagicRule('application/metalink+xml', 50, 280, [
            new MagicMatch(0, 257, '<metalink version="3.0"', '', 0),
        ]),
        new MagicRule('application/metalink4+xml', 50, 277, [
            new MagicMatch(0, 257, '<metalink xmlns="urn', '', 0),
        ]),
        new MagicRule('application/mxf', 50, 271, [
            new MagicMatch(0, 257, "\x06\x0E+4\x02\x05\x01\x01\r\x01\x02\x01\x01\x02", '', 0),
        ]),
        new MagicRule('application/ogg', 50, 5, [
            new MagicMatch(0, 1, 'OggS', '', 0),
        ]),
        new MagicRule('application/owl+xml', 50, 266, [
            new MagicMatch(0, 257, '<Ontology', '', 0),
        ]),
        new MagicRule('application/pdf', 50, 1030, [
            new MagicMatch(0, 1025, '%PDF-', '', 0),
        ]),
        ...
        new MagicRule('application/sdp', 50, 259, [
            new MagicMatch(0, 1, 'v=', '', 0, [new MagicMatch(0, 257, 's=', '', 0)]),
        ]),
        ...
        new MagicRule('application/vnd.appimage', 50, 12, [
            new MagicMatch(1, 1, 'ELF', '', 0, [new MagicMatch(8, 1, 'A', '', 0, [new MagicMatch(9, 1, 'I', '', 0, [new MagicMatch(10, 1, "\x02", '', 0)])])]),
        ]),
        ...
        new MagicRule('application/vnd.debian.binary-package', 50, 15, [
            new MagicMatch(0, 1, '!<arch>', '', 0, [new MagicMatch(8, 1, 'debian', '', 0)]),
        ]),
        ...
        new MagicRule('application/vnd.flatpak.ref', 50, 270, [
            new MagicMatch(0, 257, '[Flatpak Ref]', '', 0),
        ]),
        new MagicRule('application/vnd.flatpak.repo', 50, 271, [
            new MagicMatch(0, 257, '[Flatpak Repo]', '', 0),
        ]),
        ...
        new MagicRule('application/x-abiword', 50, 274, [
            new MagicMatch(0, 257, '<abiword', '', 0),
            new MagicMatch(0, 257, '<!DOCTYPE abiword', '', 0),
        ]),
        ...
        new MagicRule('application/x-aportisdoc', 50, 69, [
            ...
            new MagicMatch(60, 1, 'TEXtTlDc', '', 0),
        ]),
        new MagicRule('application/x-apple-systemprofiler+xml', 50, 419, [
            new MagicMatch(0, 257, '<plist version="1.0"', '', 0, [new MagicMatch(34, 351, '<key>_SPCommandLineArguments</key>', '', 0)]),
        ]),
        new MagicRule('application/x-applix-spreadsheet', 50, 20, [
            new MagicMatch(0, 1, '*BEGIN SPREADSHEETS', '', 0),
            new MagicMatch(0, 1, '*BEGIN', '', 0, [new MagicMatch(7, 1, 'SPREADSHEETS', '', 0)]),
        ]),
        new MagicRule('application/x-applix-word', 50, 13, [
            new MagicMatch(0, 1, '*BEGIN', '', 0, [new MagicMatch(7, 1, 'WORDS', '', 0)]),
        ]),
        new MagicRule('application/x-arj', 50, 3, [
            new MagicMatch(0, 1, "`\xEA", '', 0),
        ]),
        new MagicRule('application/x-asar', 50, 26, [
            new MagicMatch(0, 1, "\x04\x00\x00\x00", '', 0, [new MagicMatch(16, 1, '{"files":', '', 0)]),
        ]),
        ...
        new MagicRule('application/x-cdrdao-toc', 50, 24, [
            ...
            new MagicMatch(0, 1, 'CATALOG "', '', 0, [new MagicMatch(22, 1, '"', '', 0)]),
        ]),
        new MagicRule('application/x-cisco-vpn-settings', 50, 266, [
            new MagicMatch(0, 1, '[main]', '', 0, [new MagicMatch(0, 257, 'AuthType=', '', 0)]),
        ]),
        ...
        new MagicRule('application/x-core', 50, 19, [
            ...
            new MagicMatch(0, 1, "\x7FELF", '', 0, [new MagicMatch(5, 1, "\x01", '', 0, [new MagicMatch(16, 1, "\x04\x00", '', 0)])]),
            new MagicMatch(0, 1, "\x7FELF", '', 0, [new MagicMatch(5, 1, "\x02", '', 0, [new MagicMatch(16, 1, "\x00\x04", '', 0)])]),
            new MagicMatch(0, 1, "Core\x01", '', 0),
            new MagicMatch(0, 1, "Core\x02", '', 0),
        ]),
        new MagicRule('application/x-csh', 50, 30, [
            new MagicMatch(2, 15, '/bin/tcsh', '', 0),
            new MagicMatch(2, 15, '/bin/csh', '', 0),
            new MagicMatch(2, 15, '/bin/env csh', '', 0),
            new MagicMatch(2, 15, '/bin/env tcsh', '', 0),
        ]),
        new MagicRule('application/x-dar', 50, 5, [
            new MagicMatch(0, 1, "\x00\x00\x00{", '', 0),
        ]),
        new MagicRule('application/x-designer', 50, 261, [
            new MagicMatch(0, 257, '<ui ', '', 0),
            new MagicMatch(0, 257, '<UI ', '', 0),
        ]),
        new MagicRule('application/x-desktop', 50, 48, [
            new MagicMatch(0, 33, '[Desktop Entry]', '', 0),
        ...
        new MagicRule('application/x-dia-diagram', 50, 106, [
            new MagicMatch(5, 96, '<dia:', '', 0),
        ]),
        new MagicRule('application/x-dia-shape', 50, 107, [
            new MagicMatch(5, 96, '<shape', '', 0),
        ]),
        ...
        new MagicRule('application/x-font-dos', 50, 12, [
            ...
            new MagicMatch(7, 1, "\x00EGA", '', 0),
            new MagicMatch(7, 1, "\x00VID", '', 0),
        ]),
        ...
        new MagicRule('application/x-font-tex-tfm', 50, 5, [
            new MagicMatch(2, 1, "\x00\x11", '', 0),
            new MagicMatch(2, 1, "\x00\x12", '', 0),
        ]),
        new MagicRule('application/x-font-ttx', 50, 310, [
            new MagicMatch(0, 257, '<ttFont sfntVersion="\\x00\\x01\\x00\\x00" ttLibVersion="', '', 0),
        ]),
        new MagicRule('application/x-font-vfont', 50, 5, [
            new MagicMatch(0, 1, 'FONT', '', 0),
        ]),
        new MagicRule('application/x-gameboy-color-rom', 50, 325, [
            new MagicMatch(260, 1, "\xCE\xEDff\xCC\r\x00\v\x03s\x00\x83\x00\f\x00\r\x00\x08", '', 0, [new MagicMatch(323, 1, "\x80", "\x80", 0)]),
        ]),
        new MagicRule('application/x-gameboy-rom', 50, 325, [
            new MagicMatch(260, 1, "\xCE\xEDff\xCC\r\x00\v\x03s\x00\x83\x00\f\x00\r\x00\x08\x11\x1F\x88\x89\x00\x0E", '', 0, [new MagicMatch(323, 1, "\x00", "\x80", 0)]),
        ]),
        ...
        new MagicRule('application/x-genesis-rom', 50, 645, [
            new MagicMatch(256, 1, 'SEGA GENESIS', '', 0),
            new MagicMatch(256, 1, 'SEGA MEGA DRIVE', '', 0),
            new MagicMatch(256, 1, 'SEGA_MEGA_DRIVE', '', 0),
            new MagicMatch(640, 1, 'EAGN', '', 0),
            new MagicMatch(640, 1, 'EAMG', '', 0),
        ]),
        ...
        new MagicRule('application/x-glade', 50, 273, [
            new MagicMatch(0, 257, '<glade-interface', '', 0),
        ]),
        new MagicRule('application/x-gnumeric', 50, 77, [
            new MagicMatch(0, 65, 'gmr:Workbook', '', 0),
            new MagicMatch(0, 65, 'gnm:Workbook', '', 0),
        ]),
        ...
        new MagicRule('application/x-gtk-builder', 50, 267, [
            new MagicMatch(0, 257, '<interface', '', 0),
        ]),
        ...
        new MagicRule('application/x-iso9660-appimage', 50, 12, [
            new MagicMatch(1, 1, 'ELF', '', 0, [new MagicMatch(8, 1, 'A', '', 0, [new MagicMatch(9, 1, 'I', '', 0, [new MagicMatch(10, 1, "\x01", '', 0)])])]),
        ]),
        ...
        new MagicRule('application/x-ksysv-package', 50, 17, [
            new MagicMatch(4, 1, 'KSysV', '', 0, [new MagicMatch(15, 1, "\x01", '', 0)]),
        ]),
        ...
        new MagicRule('application/x-matroska', 50, 84, [
            new MagicMatch(0, 1, "\x1AE\xDF\xA3", '', 0, [new MagicMatch(5, 61, "B\x82", '', 0, [new MagicMatch(8, 68, 'matroska', '', 0)])]),
        ]),
        ...
        new MagicRule('application/x-mswinurl', 50, 20, [
            new MagicMatch(1, 1, 'InternetShortcut', '', 0),
            new MagicMatch(1, 1, 'DEFAULT', '', 0, [new MagicMatch(11, 1, 'BASEURL=', '', 0)]),
        ]),
        ...
        new MagicRule('application/x-nautilus-link', 50, 63, [
            new MagicMatch(0, 33, '<nautilus_object nautilus_link', '', 0),
        ]),
        new MagicRule('application/x-navi-animation', 50, 13, [
            new MagicMatch(0, 1, 'RIFF', '', 0, [new MagicMatch(8, 1, 'ACON', '', 0)]),
        ]),
        new MagicRule('application/x-neo-geo-pocket-color-rom', 50, 37, [
            new MagicMatch(35, 1, "\x10", '', 0, [new MagicMatch(0, 1, 'COPYRIGHT BY SNK CORPORATION', '', 0), new MagicMatch(0, 1, ' LICENSED BY SNK CORPORATION', '', 0)]),
        ]),
        new MagicRule('application/x-neo-geo-pocket-rom', 50, 37, [
            new MagicMatch(35, 1, "\x00", '', 0, [new MagicMatch(0, 1, 'COPYRIGHT BY SNK CORPORATION', '', 0), new MagicMatch(0, 1, ' LICENSED BY SNK CORPORATION', '', 0)]),
        ]),
        ...
        new MagicRule('application/x-object', 50, 19, [
            new MagicMatch(0, 1, "\x7FELF", '', 0, [new MagicMatch(5, 1, "\x01", '', 0, [new MagicMatch(16, 1, "\x01\x00", '', 0)])]),
            new MagicMatch(0, 1, "\x7FELF", '', 0, [new MagicMatch(5, 1, "\x02", '', 0, [new MagicMatch(16, 1, "\x00\x01", '', 0)])]),
        ]),
        ...
        new MagicRule('application/x-perl', 50, 267, [
            ...
            new MagicMatch(2, 15, '/bin/perl', '', 0),
            new MagicMatch(2, 15, '/bin/env perl', '', 0),
            new MagicMatch(0, 257, 'use Test::', '', 0),
        ]),
        ...
        new MagicRule('application/x-qemu-disk', 50, 5, [
            new MagicMatch(0, 1, 'QFI', '', 0, [new MagicMatch(3, 1, "\xFB", '', 0)]),
        ]),
        ...
        new MagicRule('application/x-ruby', 50, 30, [
            new MagicMatch(2, 15, '/bin/env ruby', '', 0),
            new MagicMatch(2, 15, '/bin/ruby', '', 0),
        ]),
        new MagicRule('application/x-sami', 50, 263, [
            new MagicMatch(0, 257, '<SAMI>', '', 0),
        ]),
        new MagicRule('application/x-saturn-rom', 50, 32, [
            new MagicMatch(0, 1, 'SEGA SEGASATURN', '', 0),
            new MagicMatch(16, 1, 'SEGA SEGASATURN', '', 0),
        ]),
        ...
        new MagicRule('application/x-sharedlib', 50, 25, [
            new MagicMatch(0, 1, "\x83\x01", '', 0, [new MagicMatch(22, 1, "\x00 ", "\x000", 0)]),
        ]),
        new MagicRule('application/x-shellscript', 50, 36, [
            new MagicMatch(10, 1, '# This is a shell archive', '', 0),
            new MagicMatch(2, 15, '/bin/bash', '', 0),
            new MagicMatch(2, 15, '/bin/nawk', '', 0),
            new MagicMatch(2, 15, '/bin/zsh', '', 0),
            new MagicMatch(2, 15, '/bin/sh', '', 0),
            new MagicMatch(2, 15, '/bin/ksh', '', 0),
            new MagicMatch(2, 15, '/bin/dash', '', 0),
            new MagicMatch(2, 15, '/bin/env sh', '', 0),
            new MagicMatch(2, 15, '/bin/env bash', '', 0),
            new MagicMatch(2, 15, '/bin/env zsh', '', 0),
            new MagicMatch(2, 15, '/bin/env ksh', '', 0),
        ]),
        ...
        new MagicRule('application/x-subrip', 50, 262, [
            new MagicMatch(0, 1, '1', '', 0, [new MagicMatch(0, 257, ' --> ', '', 0)]),
        ]),
        ...
        new MagicRule('application/x-wii-rom', 50, 29, [
            new MagicMatch(24, 1, "]\x1C\x9E\xA3", '', 0),
            new MagicMatch(0, 1, 'WBFS', '', 0),
            new MagicMatch(0, 1, "WII\x01DISC", '', 0),
        ]),
        new MagicRule('application/x-wii-wad', 50, 9, [
            new MagicMatch(4, 1, "Is\x00\x00", '', 0),
            new MagicMatch(4, 1, "ib\x00\x00", '', 0),
            new MagicMatch(4, 1, "Bk\x00\x00", '', 0),
        ]),
        ...
        new MagicRule('audio/x-adpcm', 50, 17, [
            new MagicMatch(0, 1, '.snd', '', 0, [new MagicMatch(12, 1, "\x00\x00\x00\x17", '', 0)]),
            new MagicMatch(0, 1, ".sd\x00", '', 0, [new MagicMatch(12, 1, "\x01\x00\x00\x00", '', 0), new MagicMatch(12, 1, "\x02\x00\x00\x00", '', 0), new MagicMatch(12, 1, "\x03\x00\x00\x00", '', 0), new MagicMatch(12, 1, "\x04\x00\x00\x00", '', 0), new MagicMatch(12, 1, "\x05\x00\x00\x00", '', 0), new MagicMatch(12, 1, "\x06\x00\x00\x00", '', 0), new MagicMatch(12, 1, "\x07\x00\x00\x00", '', 0), new MagicMatch(12, 1, "\x17\x00\x00\x00", '', 0)]),
        ]),
        new MagicRule('audio/x-aifc', 50, 13, [
            new MagicMatch(8, 1, 'AIFC', '', 0),
        ]),
        new MagicRule('audio/x-aiff', 50, 13, [
            new MagicMatch(8, 1, 'AIFF', '', 0),
            new MagicMatch(8, 1, '8SVX', '', 0),
        ]),
        new MagicRule('audio/x-ape', 50, 5, [
            new MagicMatch(0, 1, 'MAC ', '', 0),
        ]),
        new MagicRule('audio/x-dff', 50, 17, [
            new MagicMatch(0, 1, 'FRM8', '', 0, [new MagicMatch(12, 1, 'DSD ', '', 0)]),
        ]),
        new MagicRule('audio/x-dsf', 50, 85, [
            new MagicMatch(0, 1, 'DSD ', '', 0, [new MagicMatch(28, 1, 'fmt ', '', 0, [new MagicMatch(80, 1, 'data', '', 0)])]),
        ]),
        ...
        new MagicRule('audio/x-stm', 50, 30, [
            new MagicMatch(20, 1, "!Scream!\x1A", '', 0),
            new MagicMatch(20, 1, "!SCREAM!\x1A", '', 0),
            new MagicMatch(20, 1, "BMOD2STM\x1A", '', 0),
        ]),
        ...
        new MagicRule('audio/x-wav', 50, 13, [
            new MagicMatch(8, 1, 'WAVE', '', 0),
            new MagicMatch(8, 1, 'WAV ', '', 0),
        ]),
        ...
        new MagicRule('image/avif', 50, 29, [
            new MagicMatch(4, 1, 'ftypavif', '', 0),
            new MagicMatch(4, 1, 'ftypavis', '', 0),
            new MagicMatch(4, 1, 'ftypmif1', '', 0, [new MagicMatch(16, 1, 'avif', '', 0), new MagicMatch(20, 1, 'avif', '', 0), new MagicMatch(24, 1, 'avif', '', 0)]),
        ]),
        new MagicRule('image/bmp', 50, 16, [
            new MagicMatch(0, 1, "BMxxxx\x00\x00", "\xFF\xFF\x00\x00\x00\x00\xFF\xFF", 0),
            new MagicMatch(0, 1, 'BM', '', 0, [new MagicMatch(14, 1, "\f", '', 0), new MagicMatch(14, 1, '@', '', 0), new MagicMatch(14, 1, '(', '', 0)]),
        ]),
        new MagicRule('image/dpx', 50, 5, [
            new MagicMatch(0, 1, 'SDPX', '', 0),
        ]),
        new MagicRule('image/emf', 50, 61, [
            new MagicMatch(0, 1, "\x01\x00\x00\x00", '', 0, [new MagicMatch(40, 1, ' EMF', '', 0, [new MagicMatch(44, 1, "\x00\x00\x01\x00", '', 0, [new MagicMatch(58, 1, "\x00\x00", '', 0)])])]),
        ]),
        ...
        new MagicRule('image/vnd.microsoft.icon', 50, 7, [
            new MagicMatch(0, 1, "\x00\x00\x01\x00", '', 0, [new MagicMatch(5, 1, "\x00", '', 0)]),
        ]),
        new MagicRule('image/vnd.ms-modi', 50, 5, [
            new MagicMatch(0, 1, "EP*\x00", '', 0),
        ]),
        new MagicRule('image/vnd.zbrush.pcx', 50, 3, [
            new MagicMatch(0, 1, "\n", '', 0, [new MagicMatch(1, 1, "\x00", '', 0), new MagicMatch(1, 1, "\x02", '', 0), new MagicMatch(1, 1, "\x03", '', 0), new MagicMatch(1, 1, "\x05", '', 0)]),
        ]),
        new MagicRule('image/webp', 50, 13, [
            new MagicMatch(0, 1, 'RIFF', '', 0, [new MagicMatch(8, 1, 'WEBP', '', 0)]),
        ]),
        new MagicRule('image/wmf', 50, 27, [
            new MagicMatch(0, 1, "\xD7\xCD\xC6\x9A", '', 0, [new MagicMatch(22, 1, "\x01\x00", '', 0, [new MagicMatch(24, 1, "\t\x00", '', 0)])]),
            new MagicMatch(0, 1, "\x01\x00", '', 0, [new MagicMatch(2, 1, "\t\x00", '', 0)]),
        ]),
        new MagicRule('image/x-applix-graphics', 50, 16, [
            new MagicMatch(0, 1, '*BEGIN', '', 0, [new MagicMatch(7, 1, 'GRAPHICS', '', 0)]),
        ]),
        ...
        new MagicRule('image/x-ilbm', 50, 13, [
            new MagicMatch(8, 1, 'ILBM', '', 0),
            new MagicMatch(8, 1, 'PBM ', '', 0),
        ]),
        ...
        new MagicRule('image/x-pict', 50, 19, [
            new MagicMatch(10, 1, "\x00\x11", '', 0, [new MagicMatch(12, 1, "\x02\xFF", '', 0, [new MagicMatch(14, 1, "\f\x00", '', 0, [new MagicMatch(16, 1, "\xFF\xFE", '', 0)])])]),
        ]),
        new MagicRule('image/x-pict', 50, 531, [
            new MagicMatch(522, 1, "\x00\x11", '', 0, [new MagicMatch(524, 1, "\x02\xFF", '', 0, [new MagicMatch(526, 1, "\f\x00", '', 0, [new MagicMatch(528, 1, "\xFF\xFE", '', 0)])])]),
        ]),
        new MagicRule('image/x-portable-bitmap', 50, 4, [
            new MagicMatch(0, 1, 'P1', '', 0, [new MagicMatch(2, 1, "\n", '', 0), new MagicMatch(2, 1, ' ', '', 0), new MagicMatch(2, 1, "\t", '', 0), new MagicMatch(2, 1, "\r", '', 0)]),
            new MagicMatch(0, 1, 'P4', '', 0, [new MagicMatch(2, 1, "\n", '', 0), new MagicMatch(2, 1, ' ', '', 0), new MagicMatch(2, 1, "\t", '', 0), new MagicMatch(2, 1, "\r", '', 0)]),
        ]),
        new MagicRule('image/x-portable-graymap', 50, 4, [
            new MagicMatch(0, 1, 'P2', '', 0, [new MagicMatch(2, 1, "\n", '', 0), new MagicMatch(2, 1, ' ', '', 0), new MagicMatch(2, 1, "\t", '', 0), new MagicMatch(2, 1, "\r", '', 0)]),
            new MagicMatch(0, 1, 'P5', '', 0, [new MagicMatch(2, 1, "\n", '', 0), new MagicMatch(2, 1, ' ', '', 0), new MagicMatch(2, 1, "\t", '', 0), new MagicMatch(2, 1, "\r", '', 0)]),
        ]),
        new MagicRule('image/x-portable-pixmap', 50, 4, [
            new MagicMatch(0, 1, 'P3', '', 0, [new MagicMatch(2, 1, "\n", '', 0), new MagicMatch(2, 1, ' ', '', 0), new MagicMatch(2, 1, "\t", '', 0), new MagicMatch(2, 1, "\r", '', 0)]),
            new MagicMatch(0, 1, 'P6', '', 0, [new MagicMatch(2, 1, "\n", '', 0), new MagicMatch(2, 1, ' ', '', 0), new MagicMatch(2, 1, "\t", '', 0), new MagicMatch(2, 1, "\r", '', 0)]),
        ]),
        new MagicRule('image/x-quicktime', 50, 9, [
            new MagicMatch(4, 1, 'idat', '', 0),
        ]),
        new MagicRule('image/x-sigma-x3f', 50, 9, [
            new MagicMatch(0, 1, 'FOVb', '', 0, [new MagicMatch(4, 1, "\xFF\x00\xFF\x00", "\x00\xFF\x00\xFF", 0)]),
        ]),
        ...
        new MagicRule('image/x-tga', 50, 18, [
            new MagicMatch(1, 1, "\x00\x02", '', 0, [new MagicMatch(16, 1, "\x08", '', 0), new MagicMatch(16, 1, "\x10", '', 0), new MagicMatch(16, 1, "\x18", '', 0), new MagicMatch(16, 1, ' ', '', 0)]),
        ]),
        new MagicRule('image/x-win-bitmap', 50, 7, [
            new MagicMatch(0, 1, "\x00\x00\x02\x00", '', 0, [new MagicMatch(5, 1, "\x00", '', 0)]),
        ]),
        ...
        new MagicRule('model/iges', 50, 82, [
            new MagicMatch(72, 1, "S      1\n", '', 0),
            new MagicMatch(72, 1, "S0000001\n", '', 0),
        ]),
        new MagicRule('model/mtl', 50, 264, [
            new MagicMatch(0, 1, '# Blender MTL File: \'', '', 0),
            new MagicMatch(0, 257, 'newmtl ', '', 0),
        ]),
        new MagicRule('model/obj', 50, 264, [
            new MagicMatch(0, 65, ' OBJ File: \'', '', 0),
            new MagicMatch(0, 257, 'mtllib ', '', 0),
        ]),
        ...
        new MagicRule('text/cache-manifest', 50, 16, [
            new MagicMatch(0, 1, 'CACHE MANIFEST', '', 0, [new MagicMatch(14, 1, ' ', '', 0), new MagicMatch(14, 1, "\t", '', 0), new MagicMatch(14, 1, "\n", '', 0), new MagicMatch(14, 1, "\r", '', 0)]),
        ]),
        ...
        new MagicRule('text/html', 50, 271, [
            new MagicMatch(0, 257, '<!DOCTYPE HTML', '', 0),
            new MagicMatch(0, 257, '<!doctype html', '', 0),
            new MagicMatch(0, 257, '<!DOCTYPE html', '', 0),
            new MagicMatch(0, 257, '<HEAD', '', 0),
            new MagicMatch(0, 257, '<head', '', 0),
            new MagicMatch(0, 257, '<HTML', '', 0),
            new MagicMatch(0, 257, '<html', '', 0),
            new MagicMatch(0, 257, '<SCRIPT', '', 0),
            new MagicMatch(0, 257, '<script', '', 0),
        ...
        new MagicRule('text/javascript', 50, 30, [
            ...
            new MagicMatch(2, 15, '/bin/env gjs', '', 0),
        ]),
        ...
        new MagicRule('text/x-devicetree-source', 50, 4089, [
            new MagicMatch(0, 1, "\x00\x00", "\x80\x80", 0, [new MagicMatch(0, 4081, '/dts-v1/', '', 0)]),
        ]),
        ...
        new MagicRule('text/x-iptables', 50, 280, [
            new MagicMatch(0, 257, '/etc/sysconfig/iptables', '', 0),
            new MagicMatch(0, 257, '*filter', '', 0, [new MagicMatch(0, 257, ':INPUT', '', 0, [new MagicMatch(0, 257, ':FORWARD', '', 0, [new MagicMatch(0, 257, ':OUTPUT', '', 0)])])]),
            new MagicMatch(0, 257, '-A INPUT', '', 0, [new MagicMatch(0, 257, '-A FORWARD', '', 0, [new MagicMatch(0, 257, '-A OUTPUT', '', 0)])]),
            new MagicMatch(0, 257, '-P INPUT', '', 0, [new MagicMatch(0, 257, '-P FORWARD', '', 0, [new MagicMatch(0, 257, '-P OUTPUT', '', 0)])]),
        ]),
        ...
        new MagicRule('text/x-lua', 50, 32, [
            new MagicMatch(2, 15, '/bin/lua', '', 0),
            new MagicMatch(2, 15, '/bin/luajit', '', 0),
            new MagicMatch(2, 15, '/bin/env lua', '', 0),
            new MagicMatch(2, 15, '/bin/env luajit', '', 0),
        ]),
        ...
        new MagicRule('text/x-python', 50, 33, [
            ...
            new MagicMatch(2, 15, '/bin/env python', '', 0),
        ]),
        new MagicRule('text/x-qml', 50, 3011, [
            new MagicMatch(2, 15, '/bin/env qml', '', 0),
            new MagicMatch(0, 3001, 'import Qt', '', 0, [new MagicMatch(9, 3001, '{', '', 0)]),
            new MagicMatch(0, 3001, 'import Qml', '', 0, [new MagicMatch(9, 3001, '{', '', 0)]),
        ]),
        ...
        new MagicRule('text/x-ssa', 50, 270, [
            new MagicMatch(0, 257, '[Script Info]', '', 0),
            new MagicMatch(0, 257, 'Dialogue: ', '', 0),
        ]),
        ...
        new MagicRule('video/3gpp', 50, 12, [
            new MagicMatch(4, 1, 'ftyp3ge', '', 0),
            new MagicMatch(4, 1, 'ftyp3gg', '', 0),
            new MagicMatch(4, 1, 'ftyp3gp', '', 0),
            new MagicMatch(4, 1, 'ftyp3gs', '', 0),
        ]),
        ...
        new MagicRule('video/mp2t', 50, 774, [
            new MagicMatch(0, 1, 'G', '', 0, [new MagicMatch(188, 1, 'G', '', 0, [new MagicMatch(376, 1, 'G', '', 0, [new MagicMatch(564, 1, 'G', '', 0, [new MagicMatch(752, 1, 'G', '', 0)])])])]),
            new MagicMatch(4, 1, 'G', '', 0, [new MagicMatch(196, 1, 'G', '', 0, [new MagicMatch(388, 1, 'G', '', 0, [new MagicMatch(580, 1, 'G', '', 0, [new MagicMatch(772, 1, 'G', '', 0)])])])]),
        ]),
        new MagicRule('video/mp4', 50, 13, [
            new MagicMatch(4, 1, 'ftypisom', '', 0),
            new MagicMatch(4, 1, 'ftypmp41', '', 0),
            new MagicMatch(4, 1, 'ftypmp42', '', 0),
            new MagicMatch(4, 1, 'ftypMSNV', '', 0),
            new MagicMatch(4, 1, 'ftypM4V ', '', 0),
            new MagicMatch(4, 1, 'ftypf4v ', '', 0),
        ]),
        ...
        new MagicRule('video/quicktime', 50, 17, [
            new MagicMatch(12, 1, 'mdat', '', 0),
            new MagicMatch(4, 1, 'mdat', '', 0),
            new MagicMatch(4, 1, 'moov', '', 0),
            new MagicMatch(4, 1, 'ftypqt', '', 0),
        ]),
        new MagicRule('video/vnd.mpegurl', 50, 8, [
            new MagicMatch(0, 1, '#EXTM4U', '', 0),
        ]),
        new MagicRule('video/vnd.radgamettools.bink', 50, 5, [
            new MagicMatch(0, 1, 'BIK', '', 0, [new MagicMatch(3, 1, 'b', '', 0), new MagicMatch(3, 1, 'f', '', 0), new MagicMatch(3, 1, 'g', '', 0), new MagicMatch(3, 1, 'h', '', 0), new MagicMatch(3, 1, 'i', '', 0)]),
            new MagicMatch(0, 1, 'KB2', '', 0, [new MagicMatch(3, 1, 'a', '', 0), new MagicMatch(3, 1, 'd', '', 0), new MagicMatch(3, 1, 'f', '', 0), new MagicMatch(3, 1, 'g', '', 0), new MagicMatch(3, 1, 'h', '', 0), new MagicMatch(3, 1, 'i', '', 0), new MagicMatch(3, 1, 'j', '', 0), new MagicMatch(3, 1, 'k', '', 0)]),
        ]),
        new MagicRule('video/vnd.radgamettools.smacker', 50, 5, [
            new MagicMatch(0, 1, 'SMK', '', 0, [new MagicMatch(3, 1, '2', '', 0), new MagicMatch(3, 1, '4', '', 0)]),
        ]),
        new MagicRule('video/vnd.youtube.yt', 50, 13, [
            new MagicMatch(4, 1, 'ftypyt4 ', '', 0),
        ]),
        new MagicRule('video/webm', 50, 80, [
            new MagicMatch(0, 1, "\x1AE\xDF\xA3", '', 0, [new MagicMatch(5, 61, "B\x82", '', 0, [new MagicMatch(8, 68, 'webm', '', 0)])]),
        ]),
        ...
        new MagicRule('video/x-msvideo', 50, 13, [
            new MagicMatch(0, 1, 'RIFF', '', 0, [new MagicMatch(8, 1, 'AVI ', '', 0)]),
            new MagicMatch(0, 1, 'AVF0', '', 0, [new MagicMatch(8, 1, 'AVI ', '', 0)]),
        ]),
        ...
        new MagicRule('application/x-executable', 40, 7, [
            new MagicMatch(0, 1, "\x7FELF", '', 0, [new MagicMatch(5, 1, "\x01", '', 0)]),
            new MagicMatch(0, 1, "\x7FELF", '', 0, [new MagicMatch(5, 1, "\x02", '', 0)]),
            new MagicMatch(0, 1, 'MZ', '', 0),
        ...
        new MagicRule('application/x-perl', 40, 276, [
            new MagicMatch(0, 257, 'use strict', '', 0),
            new MagicMatch(0, 257, 'use warnings', '', 0),
            new MagicMatch(0, 257, 'use diagnostics', '', 0),
            new MagicMatch(0, 257, "\n=pod", '', 0),
            new MagicMatch(0, 257, "\n=head1 NAME", '', 0),
            new MagicMatch(0, 257, "\n=head1 DESCRIPTION", '', 0),
            new MagicMatch(0, 257, 'BEGIN {', '', 0),
        ]),
        ...
        new MagicRule('audio/x-mod', 40, 1085, [
            ...
            new MagicMatch(112, 1, "\x00", "\x80", 0, [new MagicMatch(0, 1, 'if', '', 0, [new MagicMatch(368, 1, "\x00", "\xE0", 0, [new MagicMatch(110, 1, "\x00", "\xC0", 0, [new MagicMatch(111, 1, "\x00", "\x80", 0), new MagicMatch(111, 1, "\x80", '', 0)]), new MagicMatch(110, 1, '@', '', 0, [new MagicMatch(111, 1, "\x00", "\x80", 0), new MagicMatch(111, 1, "\x80", '', 0)])]), new MagicMatch(368, 1, ' ', '', 0, [new MagicMatch(110, 1, "\x00", "\xC0", 0, [new MagicMatch(111, 1, "\x00", "\x80", 0), new MagicMatch(111, 1, "\x80", '', 0)]), new MagicMatch(110, 1, '@', '', 0, [new MagicMatch(111, 1, "\x00", "\x80", 0), new MagicMatch(111, 1, "\x80", '', 0)])])]), new MagicMatch(0, 1, 'JN', '', 0, [new MagicMatch(368, 1, "\x00", "\xE0", 0, [new MagicMatch(110, 1, "\x00", "\xC0", 0, [new MagicMatch(111, 1, "\x00", "\x80", 0), new MagicMatch(111, 1, "\x80", '', 0)])]), new MagicMatch(368, 1, ' ', '', 0, [new MagicMatch(110, 1, '@', '', 0, [new MagicMatch(111, 1, "\x00", "\x80", 0), new MagicMatch(111, 1, "\x80", '', 0)])])])]),
            new MagicMatch(0, 1, 'MAS_UTrack_V00', '', 0),
            new MagicMatch(1080, 1, 'M.K.', '', 0),
            new MagicMatch(1080, 1, 'M!K!', '', 0),
        ]),
        new MagicRule('image/heif', 40, 13, [
            new MagicMatch(4, 1, 'ftypmif1', '', 0),
            new MagicMatch(4, 1, 'ftypmsf1', '', 0),
            new MagicMatch(4, 1, 'ftypheic', '', 0),
            new MagicMatch(4, 1, 'ftypheix', '', 0),
            new MagicMatch(4, 1, 'ftyphevc', '', 0),
            new MagicMatch(4, 1, 'ftyphevx', '', 0),
        ]),
        new MagicRule('text/html', 40, 263, [
            new MagicMatch(0, 1, '<!--', '', 0),
            new MagicMatch(0, 257, '<TITLE', '', 0),
            new MagicMatch(0, 257, '<title', '', 0),
        ]),
        new MagicRule('text/x-devicetree-source', 40, 4095, [
            new MagicMatch(0, 1, "\x00\x00", "\x80\x80", 0, [new MagicMatch(0, 4091, '/ {', '', 0), new MagicMatch(0, 4081, 'include ', '', 0, [new MagicMatch(10, 4081, '.dts', '', 0)])]),
        ]),
        ...
        new MagicRule('image/x-tga', 10, 4, [
            new MagicMatch(1, 1, "\x01\x01", '', 0),
            new MagicMatch(1, 1, "\x01\t", '', 0),
            new MagicMatch(1, 1, "\x00\x03", '', 0),
            new MagicMatch(1, 1, "\x00\n", '', 0),
            new MagicMatch(1, 1, "\x00\v", '', 0),
        ]),
