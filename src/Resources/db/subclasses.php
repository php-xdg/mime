...
return new SubclassesDatabase([
    ...
    'application/x-iso9660-appimage' => ['application/x-executable', 'application/vnd.efi.iso'],
    ...
    'application/x-fishscript' => ['application/x-executable', 'text/plain'],
    'application/x-nuscript' => ['application/x-executable', 'text/plain'],
    ...
    'text/vbscript.encode' => ['application/x-executable', 'text/plain'],
